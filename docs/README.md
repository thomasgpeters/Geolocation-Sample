...
| [DEPLOYMENT_CHECKLIST.md](DEPLOYMENT_CHECKLIST.md) | **NEW** - Pure deployment checklist organized by deployment type (native, container, cloud) — companion to the Deployment Guide |
...
- **Deployment Checklist**: See [DEPLOYMENT_CHECKLIST.md](DEPLOYMENT_CHECKLIST.md) for step-by-step deployment verification
